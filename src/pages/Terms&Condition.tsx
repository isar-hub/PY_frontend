      ...
      <div className="mx-10 my-20">
        ...
        <div className="px-2 md:px-40">
          ...
          <p className="font-arialCF">
            ...
            Terms and Conditions. If you do not approve our terms and
            conditions, then you are suggested not to use our site. We are
            located at 9 , Nawab Abdur Rahmaan Street, Kolkata 700016, Park
            Street.
          </p>
        </div>
        ...
        <div className="px-2 md:px-40">
          ...
          <p className="font-arialCF">
            ...
            will be accepted after this 24-hour period.
          </p>
        </div>
